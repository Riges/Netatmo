...
namespace Netatmo.Tests
{
    public class Client : IDisposable
    {
        ...
        public async Task GetTokenShouldReturnExceptedCredentialToken()
        {
            ...
            var result = await sut.GetToken("username@email.com", "p@$$W0rd", new []{Scope.CameraAccess, Scope.CameraRead, Scope.CameraWrite, Scope.HomecoachRead, Scope.PresenceAccess, Scope.PresenceRead, Scope.StationRead, Scope.StationWrite, Scope.ThermostatRead});
